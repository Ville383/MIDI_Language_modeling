Generate piano accompaniment based on the principles of masked diffusion models (MDMs). Code and training paradigms based on the recently published ["SCALING UP MASKED DIFFUSION MODELS ON TEXT"](https://arxiv.org/pdf/2410.18514) and ["Large Language Diffusion Models"](https://arxiv.org/abs/2502.09992).
